...
pipeline_path=/mnt/chrastil/lab/users/rob/projects/DynConn
...
do
	qsub -o ${pipeline_path}/gridlog/dynconn_HO+S_400_${subjects[i]}.txt ${scripts_path}/run_dynconn_HO+S_400.sh ${subjects[i]} #the -o and -e tags just send the output and error messages to convenient folders.
done
